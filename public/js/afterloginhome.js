...
document.querySelectorAll('.parent3btn').forEach((ele, ind, array) => {
	ele.addEventListener('click', () => {
		let id = ele.id;
		if (id == 'parent31') {
			document.querySelector('#parent32').style.backgroundColor = 'white';
			document.querySelector('#parent32').style.color = 'black';
			document.querySelector('#pastshippmentssection').style.display = 'none';
			document.querySelector('#currentshippmentssection').style.display =
				'block';
			document.querySelector('#parent31').style.backgroundColor = '#0284C7';
			document.querySelector('#parent31').style.color = 'white';
		} else {
			document.querySelector('#parent31').style.backgroundColor = 'white';
			document.querySelector('#parent31').style.color = 'black';
			document.querySelector('#currentshippmentssection').style.display =
				'none';
			document.querySelector('#pastshippmentssection').style.display = 'block';
			document.querySelector('#parent32').style.backgroundColor = '#0284C7';
			document.querySelector('#parent32').style.color = 'white';
		}
	});
});
let state = 0;
